export const siteContent = {
  brand: '桌面小喇叭',
  seo: {
    title: '桌面小喇叭 - 个人开发的桌面提醒小工具',
    description: '桌面小喇叭是个人开发的免费小工具，用微信小程序把简短提醒发送到自己的 Windows 电脑，适合个人学习、小范围试用和固定电脑提醒场景。',
  ...
  hero: {
    ...
    description: '用微信小程序给自己的 Windows 电脑发送简短提醒，电脑端可以显示横幅、卡片和语音播报。本页仅用于介绍工具用途、下载方式和基本使用流程。',
    actions: [
