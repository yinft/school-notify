...
assert(css.includes('grid-template-rows: minmax(116px, 0.8fr) minmax(220px, 1.45fr) minmax(180px, 1fr)'), 'dashboard must fit its three content bands into the main pane')
